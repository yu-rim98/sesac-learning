...
public enum ErrorCode {
    ...
    OAUTH_TOKEN_FAILED(HttpStatus.UNAUTHORIZED, "OAUTH_TOKEN_FAILED", "토큰 발생 실패"),
    OAUTH_USER_INFO_FAILED(HttpStatus.UNAUTHORIZED, "OAITH_USER_INFO_FAILED", "소셜 유저 정보 조회 실패"),
